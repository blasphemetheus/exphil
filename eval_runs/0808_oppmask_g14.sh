...
EXLA_TARGET=host EXPHIL_GPU_MEMORY_FRACTION=0.25 bash scripts/eval_live_protocol.sh \
  checkpoints/ms_g14_oppmask.bin eval_runs/0808_g14_stand_fox \
...
EXLA_TARGET=host EXPHIL_GPU_MEMORY_FRACTION=0.25 bash scripts/eval_live_protocol.sh \
  checkpoints/ms_g14_oppmask.bin eval_runs/0808_g14_stand_mewtwo \
  --runs 1 --dummy stand --runner sync \
...
EXLA_TARGET=host EXPHIL_GPU_MEMORY_FRACTION=0.25 bash scripts/eval_live_protocol.sh \
  checkpoints/ms_g14_oppmask.bin eval_runs/0808_g14_ys \
...
EXLA_TARGET=host mix run scripts/probe_opponent_dependence.exs \
  --policies "checkpoints/ms_g14_oppmask.bin" 2>&1 | tail -5 || true
