...
if [ -z "${NEWERA4_INHIBITED:-}" ] && command -v systemd-inhibit >/dev/null 2>&1; then
  export NEWERA4_INHIBITED=1
  exec systemd-inhibit --what=sleep --who="newera4" \
...
LOG=logs/overnight_newera4_20260715.log
