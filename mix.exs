  ...
  defp docs do
    [
      ...
      extras: [
        ...
        "docs/reference/ODE_SOLVER.md",
        "docs/reference/POLICY_TYPES.md",
        "docs/guides/TESTING.md",
        "docs/planning/GOALS.md",
        "docs/planning/PROJECT_ROADMAP.md",
        # Architecture docs (all 25 for complete cross-linking)
        "docs/reference/architectures/ARCHITECTURE_GUIDE.md",
        "docs/reference/architectures/ARCHITECTURES.md",
        "docs/reference/architectures/ATTENTION.md",
        "docs/reference/architectures/DECISION_TRANSFORMER.md",
        "docs/reference/architectures/GATED_SSM.md",
        "docs/reference/architectures/GLA.md",
        "docs/reference/architectures/GRIFFIN.md",
        "docs/reference/architectures/GRU.md",
        "docs/reference/architectures/HGRN.md",
        "docs/reference/architectures/HYBRID_BUILDER.md",
        "docs/reference/architectures/JAMBA.md",
        "docs/reference/architectures/KAN.md",
        "docs/reference/architectures/LIQUID.md",
        "docs/reference/architectures/LSTM.md",
        "docs/reference/architectures/MAMBA.md",
        "docs/reference/architectures/MAMBA2_SSD.md",
        "docs/reference/architectures/MLP.md",
        "docs/reference/architectures/MOE.md",
        "docs/reference/architectures/RETNET.md",
        "docs/reference/architectures/RWKV.md",
        "docs/reference/architectures/S5.md",
        "docs/reference/architectures/SPECULATIVE_DECODING.md",
        "docs/reference/architectures/WORLD_MODEL.md",
        "docs/reference/architectures/XLSTM.md",
        "docs/reference/architectures/ZAMBA.md",
        # Research & Planning
      ...
      groups_for_extras: [
        ...
        Reference: ~r/(GOTCHAS|TESTING|GOALS|PROJECT_ROADMAP|ODE_SOLVER|POLICY_TYPES)/,
        Architectures: ~r/architectures\//,
        "Research & Planning": ~r/(RESEARCH|BITTER_LESSON|MEWTWO_TRAINING)/,
        "Advanced Topics": ~r/(EMBEDDING|GPU_OPT|MAMBA_OPT|SELF_PLAY|IC_TECH)/,
